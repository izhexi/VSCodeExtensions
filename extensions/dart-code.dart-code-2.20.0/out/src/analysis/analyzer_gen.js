...
class AnalyzerGen extends stdio_service_1.StdIOService {
    constructor(getLogFile, maxLogLineLength) {
        super(getLogFile, (message, severity) => log_1.log(message, severity, utils_1.LogCategory.Analyzer), maxLogLineLength);
    ...
    handleNotification(evt) {
        switch (evt.event) {
            case "server.connected":
                this.notify(this.serverConnectedSubscriptions, evt.params);
                break;
            case "server.error":
                this.notify(this.serverErrorSubscriptions, evt.params);
                break;
            case "server.status":
                this.notify(this.serverStatusSubscriptions, evt.params);
                break;
            case "analysis.analyzedFiles":
                this.notify(this.analysisAnalyzedFilesSubscriptions, evt.params);
                break;
            case "analysis.closingLabels":
                this.notify(this.analysisClosingLabelsSubscriptions, evt.params);
                break;
            case "analysis.errors":
                this.notify(this.analysisErrorsSubscriptions, evt.params);
                break;
            case "analysis.flushResults":
                this.notify(this.analysisFlushResultsSubscriptions, evt.params);
                break;
            case "analysis.folding":
                this.notify(this.analysisFoldingSubscriptions, evt.params);
                break;
            case "analysis.highlights":
                this.notify(this.analysisHighlightsSubscriptions, evt.params);
                break;
            case "analysis.implemented":
                this.notify(this.analysisImplementedSubscriptions, evt.params);
                break;
            case "analysis.invalidate":
                this.notify(this.analysisInvalidateSubscriptions, evt.params);
                break;
            case "analysis.navigation":
                this.notify(this.analysisNavigationSubscriptions, evt.params);
                break;
            case "analysis.occurrences":
                this.notify(this.analysisOccurrencesSubscriptions, evt.params);
                break;
            case "analysis.outline":
                this.notify(this.analysisOutlineSubscriptions, evt.params);
                break;
            case "analysis.overrides":
                this.notify(this.analysisOverridesSubscriptions, evt.params);
                break;
            case "completion.results":
                this.notify(this.completionResultsSubscriptions, evt.params);
                break;
            case "search.results":
                this.notify(this.searchResultsSubscriptions, evt.params);
                break;
            case "execution.launchData":
                this.notify(this.executionLaunchDataSubscriptions, evt.params);
                break;
            case "flutter.outline":
                this.notify(this.flutterOutlineSubscriptions, evt.params);
                break;
        }
    }
    /**
    ...
    */
    flutterGetChangeAddForDesignTimeConstructor(request) {
...
//# sourceMappingURL=analyzer_gen.js.map