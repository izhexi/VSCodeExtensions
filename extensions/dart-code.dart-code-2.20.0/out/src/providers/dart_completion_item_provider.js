    ...
    provideCompletionItems(document, position, token, context) {
        ...
        return new Promise((resolve, reject) => {
            this.analyzer.completionGetSuggestionsResults({
                ...
                resolve(new vscode_1.CompletionList(resp.results.map((r) => this.convertResult(document, nextCharacter, enableCommitCharacters, insertArgumentPlaceholders, resp, r))));
            }, () => reject());
        });
    }
